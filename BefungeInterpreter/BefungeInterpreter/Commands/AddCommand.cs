...
// <summary>Defines the add command of the befunge program interpreter.</summary>
//-----------------------------------------------------------------------
namespace BefungeInterpreter.Commands
{
    ...
    /// <summary>
    /// Defines the add command of the <see cref="BefungeProgram"/> interpreter.
    /// </summary>
    public class AddCommand : BaseCommand
    {
        ...
        public void Execute(BefungeProgram program)
        {
            ...
            // Adds the values together and pushes the result on the stack.
