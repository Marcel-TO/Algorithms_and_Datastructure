//-----------------------------------------------------------------------
// <copyright file="StringCommand.cs" company="FHWN">
//     Copyright (c) Marcel Turobin-Ort. All rights reserved.
// </copyright>
// <author>Marcel Turobin-Ort</author>
// <summary>Defines the string command of the befunge program interpreter.</summary>
//-----------------------------------------------------------------------
namespace BefungeInterpreter.Commands
{
    ...
    /// <summary>
    /// Defines the string command of the <see cref="BefungeProgram"/> interpreter.
    /// </summary>
    public class StringCommand : BaseCommand
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StringCommand"/> class.
        /// </summary>
        ...
        public void Execute(BefungeProgram program)
        {
            ...
            // Checks if string format is already active and deactivates it, otherwise activates it.
